...
const Testimonial = () => {
  ...
  return (
<section className='relative z-2 py-24 md:py-28 lg:py-48'>

<div className='container  block lg:flex '>
<div className='testimonial_head-res relative z-2 mr-20 flex-300'>
    <p className='caption mb-5 max-md:mb-2.5'>wall of love</p>
    <h3 className='h3 max-md:h5  lg:sticky lg:top-0 lg:left-0 text-p4'>words from our fans</h3>
</div>
