...
const Header = () => {
  ...
  return (
    <header className="fixed  top-0 left-0 z-50 w-full py-10">
      ...
      <div className={clsx("w-full max-lg:fixed max-lg:top-0 max-lg:left-0  max-lg:w-full max-lg::bg-s2 max-lg:opacity-0",isOpen ?"max-lg:opacity-100":"pointer-events-none")}>
        <div className="max-lg:relative max-lg:flex max-lg:flex-col max-lg:min-h-screen max-lg:p-6 max-lg:overflow-hidden sidebar-before  max-md:px-4">
          ...
          <div className="lg:hidden block absolute top-1/2 left-0 w-[960px] h-[380px] translate-x-[-290px]">
            ...
            height={380}
            alt="outline"
            className="relative z-2 inset-0 mix-blend-soft-light opacity-5"
      ...
      <button className="lg:hidden z-2 size-10 border-2 border-s2/25 rounded-full flex justify-center items-center" onClick={()=>setIsOpen((prev)=>!prev)}>
          <img
